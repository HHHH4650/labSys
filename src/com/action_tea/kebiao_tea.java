...
public class kebiao_tea extends HttpServlet {
	...
	public void kebiaoAdd(HttpServletRequest request,HttpServletResponse response) {
		...
		int tea_id = (Integer) session.getAttribute("tea_id");
		...
		if(b1==true || b2==true || b3==true) {
			if(b1==true){
				...
				request.setAttribute("path", "teacherPage/kebiao/kebiaoAdd_tea.jsp");
			}else if(b2==true){
				if(b3==true){
			...
			request.setAttribute("path", "kebiao_tea?type=kebiaoMana");
		}
	...
	public void kebiaoMana(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("teacherPage/kebiao/kebiaoMana.jsp").forward(request, response);
	}
	...
	public void kebiaoSearch(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException
	{
		...
		request.setAttribute("fangshi", fangshi);
		request.setAttribute("banji_id", banji_id);
		request.getRequestDispatcher("teacherPage/kebiao/kebiaoMana2.jsp").forward(request, response);
	}
	/*
	 * 跳转页面
	 */
