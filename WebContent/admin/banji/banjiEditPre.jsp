...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <script type="text/javascript">
           ...
           function zhuanyeAll()
           {
               if(i==0)
               {
                   ...
                   getAllService.zhuanyeAll(callback);
                   i=1;
               }
           }
	...
	<body leftmargin="2" topmargin="9">
			<form action="<%=path %>/banji?type=banjiEdit" name="formAdd" method="post">
					...
					<tr align='center' bgcolor="#FFFFFF" height="22">
					    ...
					    <td width="75%" bgcolor="#FFFFFF" align="left">
					        <table border="0">
						           <tr> 
						               <td>  
						                  <select name="zhuanye_id" id="zhuanye_id" onclick="zhuanyeAll()">
